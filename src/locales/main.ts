...
export const mainTranslations = {
  en: {
    ...
    dashboard: {
      ...
      interviewPractices: 'Interview Practices',
      resumeBuilder: 'Resume Builder',
      startNew: 'Start new',
      continue: 'Continue',
      start: 'Start',
      rechargeAndContinue: 'Recharge & continue',
      inProgress: 'In progress',
      finalStep: 'Final step',
      step: 'Step',
      creditsFinished: 'Credits finished',
      startBuildingFirst: 'Start building your first resume',
      paused: 'Paused',
      suggestedPositions: 'Suggested Positions',
      more: 'More',
      loadingSuggested: 'Loading suggested positions…',
      noSuggested: 'No suggested positions yet.',
      fitWithPosition: 'Fit with this Position',
      techStack: 'Tech stack',
      apply: 'Apply',
      creditsDepletedTitle: 'Looks like your current credits have wrapped up!',
      creditsDepletedDesc: 'Recharge now to continue your resume.',
      ...
      view: 'View',
      join: 'Join',
      communityTelTitle: 'Front end channel!',
      communityTelSubtitle: 'Telegram — 2,638 Members',
      communityInstaTitle: 'Front end Instagram',
      communityInstaSubtitle: 'Instagram — 2,337 Followers',
      failedToLoadPositions: 'Failed to load suggested positions.',
      startNewConfirm: 'Start a new resume? This will discard your current in-progress resume draft.',
      yourResume: 'Your Resume',
      resumeOf: "{{name}}'s Resume",
      locationRemote: 'Remote',
      locationHybrid: 'Hybrid',
      locationOnsite: 'Onsite',
      featureLocked: 'Feature locked',
      featureLockedHeadline: '"{{name}}" is disabled for your account.',
      featureLockedBody: 'Enable it in More Features (Step 3) to unlock it for your dashboard.',
      enableInMoreFeatures: 'Enable in More Features',
      help: 'Help',
      activate: 'Activate',
      draftCoverLetter: 'Draft Your Initial Cover Letter',
      prepareFirstInterview: 'Prepare for Your First Interview',
      interviewMeta: '20 Questions • 5 mins',
      identifySkillGaps: 'Identify Your Skill Gaps',
      loading: 'Loading…',
      activateNow: 'Activate Now',
      createResumeFirst: 'Create a resume first',
      failedToLoadResumes: 'Failed to load your resumes.',
    },
    sidebar: {
      menu: 'Menu',
      dashboard: 'Dashboard',
    ...
    history: {
      ...
      levelEntry: 'Entry',
      sizeUnitMb: 'MB',
      positionProgrammingLanguages: 'Programming Languages',
      positionWebFrameworks: 'Web Frameworks',
    },
    historyEdite: {
      page: {
        missingHistoryId: 'Missing history id.',
        failedToLoadHistory: 'Failed to load this history item.',
      },
      preview: {
        missingResumeId: 'Missing resume id. Please go back and try again.',
        resumeStillLoading: 'Resume is still loading. Please wait a moment and try again.',
        ...
        resumePreviewAlt: 'Resume preview',
        suggestedPositionsCount: '3 Suggested Position',
        voice: 'Voice',
        photo: 'Photo',
        video: 'Video',
      },
      tabs: {
        ...
        coverLetter: 'Cover letter',
        featureLocked: 'Feature locked',
        featureLockedHeadline: (name: string) => `"${name}" is disabled for your account.`,
        featureLockedBody: 'Buy coins/upgrade your plan, then enable it in More Features (Step 3).',
        buyPlanCoins: 'Buy plan / coins',
      },
      interviewQuestions: {
        question: 'Question',
        answer: 'Answer',
        ...
        answerSample: 'Access common and position-specific interview questions to prepare effectively.',
      },
      positions: {
        suggestedPositions: 'Suggested Positions',
        bookmarks: 'Bookmarks',
        fitWithPosition: 'Fit with this Position',
        apply: 'Apply',
        missingResumeId: 'Missing resume id.',
        failedToLoadPositions: 'Failed to load suggested positions.',
        noSuggestedPositions: 'No suggested positions yet.',
      ...
      coverLetter: {
        coverLetterFallback: 'Cover letter',
        failedToLoad: 'Failed to load cover letter',
        showingSaved: 'Showing your saved cover letters. To filter by a resume, open this page with ?requestId=...',
        showingMerged: 'Showing all your saved cover letters (including other resumes).',
        addNew: 'Add New',
        loadingCoverLetter: 'Loading cover letter...',
        noCoverLetterForRequest: 'No cover letter found for this request.',
        noSavedCoverLetters: "You don't have any saved cover letters yet.",
      ...
      createCoverLetterDialog: {
        ...
        pasteCvContent: 'Paste your CV content...',
        subject: 'Subject',
        ...
        cvContentRequired: 'CV content is required',
        jobDescriptionRequired: 'Job description is required',
        somethingWentWrong: 'Something went wrong',
        notReadyYet: 'Cover letter is not ready yet. Please try again in a moment.',
        dismissLabel: 'Close',
      },
    },
    moreFeatures: {
    ...
    landing: {
      ...
      wizard: {
        ...
        resumeEditor: {
          ...
          noExperienceFound: 'No professional experience found.',
          noAdditionalInfoFound: 'No additional information found.',
          noEducationFound: 'No education found.',
          noCertificatesFound: 'No certificates found.',
          noSelectedProjectsFound: 'No selected projects found.',
          noProjectsFound: 'No projects found.',
          noCompetenciesFound: 'No competencies found.',
          noInterestsFound: 'No interests found.',
          noSkillsSummaryFound: 'No skills summary found.',
          profileHeader: {
        ...
        resumeGeneratorFrame: {
          resume: 'Resume',
          resumeTitleWithName: (name: string) => `${name}'s Resume`,
          created: 'Created:',
          size: 'Size:',
          fitScore: 'Fit score:',
          ...
          previewRenderError: 'Failed to render PDF preview.',
          closePreview: 'Close preview',
          resumePreviewAlt: 'Resume preview',
          loadingFeatures: 'Loading features...',
          failedToLoadFeatures: 'Failed to load features',
          noFeatureData: 'No feature data available.',
          experienceLevelLabels: {} as Record<string, string>,
  ...
  fa: {
    ...
    dashboard: {
      ...
      resumesCreated: 'رزومه‌های ساخته‌شده',
      interviewPractices: 'تمرین مصاحبه',
      resumeBuilder: 'ساخت رزومه',
      startNew: 'شروع جدید',
      continue: 'ادامه',
      start: 'شروع',
      rechargeAndContinue: 'شارژ و ادامه',
      inProgress: 'در حال انجام',
      finalStep: 'مرحله نهایی',
      step: 'مرحله',
      creditsFinished: 'اعتبار تمام شد',
      startBuildingFirst: 'اولین رزومه خود را بسازید',
      paused: 'متوقف',
      suggestedPositions: 'موقعیت‌های پیشنهادی',
      more: 'بیشتر',
      loadingSuggested: 'در حال بارگذاری موقعیت‌های پیشنهادی…',
      noSuggested: 'هنوز موقعیت پیشنهادی ندارید.',
      fitWithPosition: 'تناسب با این موقعیت',
      techStack: 'فناوری‌ها',
      apply: 'درخواست',
      creditsDepletedTitle: 'به نظر می‌رسد اعتبار فعلی شما تمام شده است!',
      creditsDepletedDesc: 'الان شارژ کنید تا رزومه را ادامه دهید.',
      seeOurPlans: 'مشاهده طرح‌ها',
      coverLetter: 'نامه همراه',
      interview: 'مصاحبه',
      community: 'جامعه',
      skillGapAnalysis: 'تحلیل فاصله مهارت',
      view: 'مشاهده',
      join: 'عضویت',
      communityTelTitle: 'کانال فرانت‌اند!',
      communityTelSubtitle: 'تلگرام — ۲٬۶۳۸ عضو',
      communityInstaTitle: 'اینستاگرام فرانت‌اند',
      communityInstaSubtitle: 'اینستاگرام — ۲٬۳۳۷ دنبال‌کننده',
      failedToLoadPositions: 'بارگذاری موقعیت‌های پیشنهادی ناموفق بود.',
      startNewConfirm: 'رزومه جدید بسازید؟ پیش‌نویس فعلی رزومه شما حذف می‌شود.',
      yourResume: 'رزومه شما',
      resumeOf: 'رزومهٔ {{name}}',
      locationRemote: 'دورکاری',
      locationHybrid: 'ترکیبی',
      locationOnsite: 'حضوری',
      featureLocked: 'قفل ویژگی',
      featureLockedHeadline: '«{{name}}» برای اکانت شما غیرفعال است.',
      featureLockedBody: 'برای فعال‌سازی از بخش ویژگی‌های بیشتر (مرحله ۳) استفاده کنید.',
      enableInMoreFeatures: 'فعال در ویژگی‌های بیشتر',
      help: 'راهنما',
      activate: 'فعال‌سازی',
      draftCoverLetter: 'پیش‌نویس اولیه نامه همراه را بنویسید',
      prepareFirstInterview: 'برای اولین مصاحبه آماده شوید',
      interviewMeta: '۲۰ سوال • ۵ دقیقه',
      identifySkillGaps: 'فاصله مهارتی خود را شناسایی کنید',
      loading: 'در حال بارگذاری…',
      activateNow: 'الان فعال کنید',
      createResumeFirst: 'اول یک رزومه بسازید',
      failedToLoadResumes: 'بارگذاری رزومه‌های شما ناموفق بود.',
    },
    sidebar: {
      menu: 'منو',
      dashboard: 'داشبورد',
    ...
    history: {
      title: 'تاریخچه',
      bookmarks: 'نشان‌کتاب‌ها',
      sort: 'مرتب‌سازی',
      sortNewToOld: 'جدید به قدیم',
      sortOldToNew: 'قدیم به جدید',
      sortSize: 'حجم',
      sortFitScore: 'امتیاز تطابق',
      favorite: 'علاقه‌مندی',
      delete: 'حذف',
      edit: 'ویرایش',
      noMoreItems: 'مورد دیگری برای بارگذاری نیست',
      resumePreviewAlt: 'پیش‌نمایش رزومه',
      moreOptionsAria: 'گزینه‌های بیشتر',
      labelResume: 'رزومه',
      labelVoice: 'صدا',
      labelPhoto: 'عکس',
      labelVideo: 'ویدیو',
      levelMid: 'میانی',
      levelMidSenior: 'میانی\u200cارشد',
      levelJunior: 'جونیور',
      levelSenior: 'ارشد',
      levelEntry: 'تازه\u200cکار',
      sizeUnitMb: 'مگابایت',
      positionProgrammingLanguages: 'زبان‌های برنامه‌نویسی',
      positionWebFrameworks: 'چارچوب‌های وب',
    },
    historyEdite: {
      page: {
        missingHistoryId: 'شناسه تاریخچه موجود نیست.',
        failedToLoadHistory: 'بارگذاری این مورد تاریخچه ناموفق بود.',
      },
      preview: {
        missingResumeId: 'شناسه رزومه موجود نیست. لطفاً برگردید و دوباره تلاش کنید.',
        resumeStillLoading: 'رزومه هنوز در حال بارگذاری است. لطفاً کمی صبر کنید و دوباره تلاش کنید.',
        failedToGeneratePdf: 'تولید PDF ناموفق بود. دوباره تلاش کنید.',
        resumeFallback: 'رزومه',
        edit: 'ویرایش',
        download: 'دانلود',
        preparingPdf: (p: number) => `آماده‌سازی PDF… ${p}٪`,
        resumePreviewAlt: 'پیش‌نمایش رزومه',
        suggestedPositionsCount: '۳ موقعیت شغلی پیشنهادی',
        voice: 'صدا',
        photo: 'عکس',
        video: 'ویدیو',
      },
      tabs: {
        suggestedInterviewQuestions: 'سوالات مصاحبه پیشنهادی',
        suggestedPositions: 'موقعیت‌های پیشنهادی',
        skillGap: 'شکاف مهارت',
        coverLetter: 'نامه همراه',
        featureLocked: 'قفل قابلیت',
        featureLockedHeadline: (name: string) => `«${name}» برای اکانت شما غیرفعال است.`,
        featureLockedBody: 'سکه بخرید یا پلن ارتقا دهید، سپس در امکانات بیشتر (مرحله ۳) فعال کنید.',
        buyPlanCoins: 'خرید پلن / سکه',
      },
      interviewQuestions: {
        question: 'سوال',
        answer: 'پاسخ',
        ...
        answerSample: 'دسترسی به سوالات رایج و مرتبط با موقعیت شغلی برای آمادگی مؤثر.',
      },
      positions: {
        suggestedPositions: 'موقعیت‌های پیشنهادی',
        bookmarks: 'نشان‌کتاب‌ها',
        fitWithPosition: 'تناسب با این موقعیت',
        apply: 'درخواست',
        missingResumeId: 'شناسه رزومه موجود نیست.',
        failedToLoadPositions: 'بارگذاری موقعیت‌های پیشنهادی ناموفق بود.',
        noSuggestedPositions: 'هنوز موقعیت پیشنهادی ندارید.',
        removeBookmark: 'حذف نشان‌کتاب',
        addBookmark: 'افزودن نشان‌کتاب',
        untitledPosition: 'موقعیت بدون عنوان',
        techStackLabel: 'فناوری‌ها',
      },
      skillGapCard: {
        free: 'رایگان',
        more: 'بیشتر',
      ...
      coverLetter: {
        coverLetterFallback: 'نامه همراه',
        failedToLoad: 'بارگذاری نامه همراه ناموفق بود',
        showingSaved: 'نامه‌های همراه ذخیره‌شده شما. برای فیلتر بر اساس رزومه، این صفحه را با ?requestId=... باز کنید.',
        showingMerged: 'همه نامه‌های همراه ذخیره‌شده شما (از جمله رزومه‌های دیگر) نمایش داده می‌شود.',
        addNew: 'افزودن جدید',
        loadingCoverLetter: 'در حال بارگذاری نامه همراه...',
        noCoverLetterForRequest: 'برای این درخواست نامه همراهی یافت نشد.',
        noSavedCoverLetters: 'هنوز نامه همراه ذخیره‌شده‌ای ندارید.',
        otherResume: 'رزومه دیگر',
        placeholder: 'نامه همراه را تایپ یا paste کنید...',
        save: 'ذخیره',
        cancel: 'انصراف',
        edit: 'ویرایش',
        copy: 'کپی',
      ...
      createCoverLetterDialog: {
        title: 'ساخت نامه همراه',
        close: 'بستن',
        companyName: 'نام شرکت',
        companyNamePlaceholder: 'نام شرکت',
        positionTitle: 'عنوان شغلی',
        jobDescriptionLabel: 'شرح شغل',
        pasteCvContent: 'محتوی رزومه را اینجا paste کنید...',
        subject: 'موضوع',
        jobDescriptionPlaceholder: 'شرح شغل',
        cancel: 'انصراف',
        create: 'ایجاد',
        companyRequired: 'نام شرکت الزامی است',
        positionRequired: 'عنوان شغلی الزامی است',
        cvContentRequired: 'محتوی رزومه الزامی است',
        jobDescriptionRequired: 'شرح شغل الزامی است',
        somethingWentWrong: 'مشکلی پیش آمد',
        notReadyYet: 'نامه همراه هنوز آماده نیست. کمی بعد دوباره تلاش کنید.',
        dismissLabel: 'بستن',
      },
    },
    moreFeatures: {
    ...
    landing: {
      ...
      wizard: {
        ...
        resumeEditor: {
          ...
          cancel: 'انصراف',
          save: 'ذخیره',
          noSummaryFound: 'خلاصه‌ای یافت نشد.',
          noSkillsFound: 'مهارتی یافت نشد.',
          noLanguagesFound: 'زبانی یافت نشد.',
          noExperienceFound: 'سابقه کاری یافت نشد.',
          noAdditionalInfoFound: 'اطلاعات تکمیلی یافت نشد.',
          noEducationFound: 'تحصیلاتی یافت نشد.',
          noCertificatesFound: 'گواهینامه‌ای یافت نشد.',
          noSelectedProjectsFound: 'پروژه‌ای یافت نشد.',
          noProjectsFound: 'پروژه‌ای یافت نشد.',
          noCompetenciesFound: 'شایستگی‌ای یافت نشد.',
          noInterestsFound: 'علاقه‌مندی یافت نشد.',
          noSkillsSummaryFound: 'خلاصه مهارتی یافت نشد.',
          profileHeader: {
        ...
        resumeGeneratorFrame: {
          resume: 'رزومه',
          resumeTitleWithName: (name: string) => `رزومهٔ ${name}`,
          created: 'ایجاد:',
          size: 'حجم:',
          ...
          previewRenderError: 'ایجاد پیش‌نمایش PDF ناموفق بود.',
          closePreview: 'بستن پیش‌نمایش',
          resumePreviewAlt: 'پیش‌نمایش رزومه',
          loadingFeatures: 'در حال بارگذاری قابلیت‌ها...',
          failedToLoadFeatures: 'بارگذاری قابلیت‌ها ناموفق بود',
          noFeatureData: 'داده‌ای برای قابلیت‌ها موجود نیست.',
